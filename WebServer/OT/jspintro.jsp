...
<head>
	...
	<style>
		...
		section section { width:975px; float:left; }
		section section video { position:relative; top:10px; left:100px; height:300px; width:700px; }
...
<body>
	<header><h2><a href="https://lunarite1.github.io/WebServer/OT/basicSemantic4.html">실습을 환영합니다.</a></h2>
		<ul id="headMenu">
			<li>로그인</li>
			<li><a href="https://lunarite1.github.io/WebServer/OT/basicSemanticMember1.html">회원가입</a></li>
			<li>사이트맵</li>
		</ul>
		<img src="../wp/scene.png" alt="히말라야"/>
	</header>
	<nav>
		<ul>
			...
			<li><a href="../jsp.jspintro.html">JSP</a></li>
		</ul>
	</nav>
	<section>
		<section><h3 id="chapter1">JSP</h3>
			<p>JSP 관련한 페이지 입니다. 장소는 대한민국 만세로 입니다. 자동차로 붐비고 있습니다.
			자동차와 자동차간 거리가 1미터 이내로 사고 우려가 높았습니다. 하지만, 다행히도 사고는 발생하지 않았습니다.
			아래가 교통상황 입니다. 애국가를 같이 불러 봅시다.
			...
			3절 가을하늘 공활한데 높고 구름없이 밝은 달은 우리 가슴 일편단심일세. 무궁화 삼천리 화려강산 대한사람 대한으로 길이 보전하세
			4절 이 기상과 이 맘으로 충성을 다하여 괴로우나 즐거우나 나라 사랑하세. 무궁화 삼천리 화려강산 대한사람 대한으로 길이 보전하세</p>
			<h4>만세로 교통상황</h4>
			<video id="traffic" controls="controls">
				<source src="../media/traffic.mp4" type="audio/mp4">
				<source src="../media/boom.ogg" type="audio/ogg">
				<source src="../media/boom.webm" type="audio/webm">
				브라우저가 지원하지 않거나 비디오 형식의 파일이 존재하지 않습니다!</video><hr />
		</section>
	</section>
